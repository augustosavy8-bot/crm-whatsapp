...
// Registro de staff por invitación: la persona define SU email + contraseña.
// La cuenta queda como profesor + admin del gimnasio. Tras crearla, inicia
// sesión y cae en el panel.
export default function RegistroStaffForm({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/registro-staff", {
        method: "POST",
